 ...
 */
public class VehiculoCamioneta extends Vehiculo implements MovimientoDerecha, MovimientoIzquierda{
     ...
     */
    public VehiculoCamioneta(String combustible, int cantidadGalonesCombustible, int cantidadPasajeros, int velocidadMaxima, double aceleracionBase) {
    ...
    public void presentarVehiculo() {
        System.out.println("Soy un vehiculo de camioneta, puedo transportar personas");
    }
